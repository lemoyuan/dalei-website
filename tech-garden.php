					...
					<div  class=" col-md-3 " id="sign">
						...
						<aside  id="floatdiv" class="canfloat  col-md-2">
							...
							<div class="widget">
									...
									<ul>
											<li><a href="/articles/article-Amercia-astronaut.php"><i class="fa fa-sign-out"></i>太空食品也辐照</a></li>
	    									<li><a href="/articles/paper-without-accel.php"><i class="fa fa-sign-out"></i>没了粒子加速器就活不下去的10个理由 </a></li>
	    									<li><a href="/articles/paper-unknown-particle-accel.php"><i class="fa fa-sign-out"></i>关于粒子加速器你可能不知道的10件事 </a></li>
									</ul>
							</div>
					...
					<div class="col-md-9">
							...
							<div id="applications" class="row">
									<div class="col-md-6 "  style="padding-left:0px">
											<div  style="background-color:#000033;padding:20px;margin-bottom:20px;border-radius:6px">
													<!-- article title -->
													<h4><a href="application-food.php">食品辐照</a></h4>

													<!-- blog short preview -->
													<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp辐照保藏不同于化学熏蒸法和腌制法，不需要加入添加物，是一种物理保藏法，具有许多传统保藏法不可比拟的优点</p>
									...
									<div class="col-md-6" style="padding-right:0px">
											<div style="background-color:#000033;padding:20px;margin-bottom:20px;border-radius:6px">
													...
													<!-- blog short preview -->
													<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;传统的储粮防治多以化学方法为主，化学药剂的长期使用不仅污染环境，而且残留药物也直接危害到人类健康 · · · · · ·</p>
									...
									<div class="col-md-6" style="padding-left:0px">
											<div style="background-color:#000033;padding:20px;margin-bottom:20px;border-radius:6px">
													...
													<!-- blog short preview -->
													<p >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;辐照技术在工业领域，特别是辐射化工、工业“三废”处理、半导体辐照等方面都有着广泛的应用 · · · · · ·</p>
									...
									<div class="col-md-6 " style="padding-right:0px">
											<div style="background-color:#000033;padding:20px;margin-bottom:20px;border-radius:6px">
													...
													<!-- blog short preview -->
													<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 医疗保健产品辐射灭菌是一项新技术，比蒸汽或环氧乙烷（Eto)灭菌法有许多优点 · · · · · ·</p>
									...
									<div class="col-md-12">
											<div style="background-color:#000033;padding:20px;margin-bottom:20px;border-radius:6px">
													...
													<!-- blog short preview -->
													<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;电子直线加速器的使用已经深入到国民经济的各个领域，目前使用最多的领域是医院的癌症治疗，其次是工业应用领域的辐照加工，辐照改性和工业探伤，另外射线的无损检查，如海关集装箱检查等也可以归到工业应用领域，直线加速器的应用在以上两个领域已得到了普遍认同和普及。 · · · · · ·</p>
					...
					<ul class="masonry-list">
						...
						<li class="masonry-item" style="background-color:#004444">
							...
							<div class="item">
								...
								<!-- blog short preview -->
								<p style="color:#fff">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;根据工业辐照直线电子加速器系统特点和工作条件的特殊性，分析了技术维护工作中应注意的要点与常见故障的排除方法，提出了保障其安全可靠运行的几项技术维护和改造措施。
								</p>
						...
						<li class="masonry-item" style="background-color:#004444">
							<div class="item">
								...
								<!-- blog short preview -->
								<p style="color:#fff">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;射线辐照加工行业是新兴的发展中的行业，身为行业之中的科技人员，不得不经常思考这样一个问题：我们是在把先进的技术如何去更好地应用，还是在应用中去发现、提高，根据应用中的需求去提炼更先进的技术和设备？
								</p>
