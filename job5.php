				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<table class="table" style="background-color:rgba(0,0,0,0.1); color:rgba(255,255,255,1);">
                            ...
                            <tr>
                              <td width="423" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>专业要求：市场营销、经营管理类等相关专业</span></td>
                              <td width="424" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>学历要求：不限</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td width="424"  style="border-top:1px dashed rgba(102,102,102,0.5);"><span>薪资待遇：面议</span></td>
                            </tr>
                        </table>
						<div class="toogle">
							...
							<div class="toggle active">
								...
								<div class="toggle-content">
									<p>1、从事市场业务与企业经营管理；<br/>
										2、熟悉电子商务；<br/>
										3、有较强的人际沟通能力，敬业，做事认真负责；<br/>
										4、有相关工作经验者优先考虑。<br/>
									</p>
								</div>
							</div>
