				...
				<section class="container">
					...
					<div class="col-md-9">
							...
							<div class="item">
								...
								<!-- blog short preview -->
								<p style="color:#fff">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;电子直线加速器的使用已经深入到国民经济的各个领域，目前使用最多的领域是医院的癌症治疗，其次是工业应用领域的辐照加工，辐照改性和工业探伤，另外射线的无损检查，如海关集装箱检查等也可以归到工业应用领域，直线加速器的应用在以上两个领域已得到了普遍认同和普及。 · · · · · ·</p>
							...
							<div class="item">
								...
								<!-- blog short preview -->
								<p style="color:#fff">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;辐照保藏不同于化学熏蒸法和腌制法，不需要加入添加物，是一种物理保藏法，具有许多传统保藏法不可比拟的优点
								</p>
							...
							<div class="item">
								...
								<!-- blog short preview -->
								<p style="color:#fff">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;传统的储粮防治多以化学方法为主，化学药剂的长期使用不仅污染环境，而且残留药物也直接危害到人类健康 · · · · · ·</p>
							...
							<div class="item">
								...
								<!-- blog short preview -->
								<p style="color:#fff">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;辐照技术在工业领域，特别是辐射化工、工业“三废”处理、半导体辐照等方面都有着广泛的应用 · · · · · ·</p>
							...
							<div class="item">
								...
								<!-- blog short preview -->
								<p style="color:#fff">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;医疗保健产品辐射灭菌是一项新技术，比蒸汽或环氧乙烷（Eto)灭菌法有许多优点 · · · · · ·</p>
