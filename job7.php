				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<table class="table" style="background-color:rgba(0,0,0,0.1); color:rgba(255,255,255,1);">
                            ...
                            <tr>
                              <td width="423" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>专业要求：工程技术类相关专业</span></td>
                              <td width="424" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>学历要求：本科及以上</span></td>
                            </tr>
                            <tr>
                              <td width="423" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>工作经验：5～10年以上</span></td>
                              <td width="424" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>外语要求：英语口语熟练</span></td>
                            </tr>
                            <tr>
                              <td width="423"  style="border-top:1px dashed rgba(102,102,102,0.5);"><span>提供食宿：提供</span></td>
                              <td width="424"  style="border-top:1px dashed rgba(102,102,102,0.5);"><span>薪资待遇：100000以上年薪</span></td>
                            </tr>
                        </table>
						<div class="toogle">
							...
							<div class="toggle active">
								...
								<div class="toggle-content">
									<p>1、从事市场营销、策划、宣传，处理与销售、服务相关事务；<br/>
										2、有一定的专业技术基础<br/>
										3、较强的人际沟通能力；<br/>
										4、有相关工作经验者优先考虑。<br/>
									</p>
							...
							<p>有意向者，请投邮箱： support@bigradium.com。</p>
