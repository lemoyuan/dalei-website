				...
				<div class="fullwidthbanner">
					<ul>	
						<li data-transition="fade" data-slotamount="7" data-masterspeed="300" >
							...
							<a href="brief-intro.html" class="btn btn-primary btn-lg">详细资料</a>
							</div>
						</li>
						<li data-transition="fade" data-slotamount="7" data-masterspeed="300" >
							...
							data-start="1100" 
							data-easing="easeOutExpo">
							<a href="eaccel.html"class="btn btn-primary btn-lg">详细资料</a>
							</div>
						</li>
						<li data-transition="fade" data-slotamount="7" data-masterspeed="300" >
							...
							data-start="1100" 
							data-easing="easeOutExpo">
							<a href="modulator.html" class="btn btn-primary btn-lg">详细资料</a>
							</div>
						</li>
			...
			<section class="container">
				<div class="row text-center">
					...
					<div class="col-md-4 col-sm-6 col-xs-12 margin-top30">
						<figure>
							<img class="img-responsive" src="assets/images/dalei/fnal-3.jpg" alt="" />
						</figure>
					...
					<div class="col-md-4 col-sm-6 col-xs-12 margin-top30">
						<figure>
							<img class="img-responsive" src="assets/images/dalei/fnal-2.jpg" alt="" />
						</figure>
					...
					<div class="col-md-4 col-sm-6 col-xs-12 margin-top30">
						<figure>
							<img class="img-responsive" src="assets/images/dalei/fnal-1.jpg" alt="" />
						</figure>
