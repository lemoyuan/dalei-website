				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<table class="table" style="background-color:rgba(0,0,0,0.1); color:rgba(255,255,255,1);">
                            ...
                            <tr>
                              <td width="423" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>专业要求：电气工程与自动化、机电一体化、通信管理等相关专业</span></td>
                              <td width="424" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>学历要求：大专及以上  </span></td>
                            </tr>
                            <tr>
						...
						<div class="toogle">
							...
							<div class="toggle active">
								...
								<div class="toggle-content">
									<p>1、从事大型电子加速器设备运行管理与技术维护；<br/>
										2、有一定的电子、机械、计算机操作方面技术基础；<br/>
										3、好学上进，责任心强；<br/>
										4、有相关工作经验者优先考虑。<br/>
									</p>
								</div>
