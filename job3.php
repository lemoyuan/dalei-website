				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<table class="table" style="background-color:rgba(0,0,0,0.1); color:rgba(255,255,255,1);">
                            ...
                            <tr>
                              <td width="423" style="border-top:1px dashed rgba(102,102,102,0.5);"><span>专业要求：电子设备与运行管理、物理电子学、测试计量技术及仪器等相关专业</span></td>
						...
						<div class="toogle">
							...
							<div class="toggle active">
								...
								<div class="toggle-content">
									<p>1、从事工业辐照射线设备电子加速器运行管理，以及射线加工应用研究、测量、管理； <br/>
										2、能熟练的使用相关测量仪器设备；<br/>
										3、好学上进，责任心强； <br/>
										4、有相关工作经验者优先考虑。
									</p>
