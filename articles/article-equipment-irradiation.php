              ...
              <div class="body-content">
                  ...
                  <h3 id="chart1"><strong>前言</strong></h3>
                      ...
                      <P style="color:#bbb">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我们都知道辐照加工射线源主要有钴60和电子加速器。对于钴源，其γ射线穿透力强、均匀度好、运行可靠性好等仍是其突出的优点；但其审批和安全管理的困难、高昂的购源和定期补源费用、射线利用率低等难以回避的问题严重限制了它的应用普及，特别是难以承受的空置损失。在当前辐照装置不断普及，辐照加工货源难以保证的情况下，空置成本的分摊将使钴60装置陷入越来越困难的境地。而且，其特性所决定的以辐照中心集中运行的商业模式有有着很大的局限性。所以，指望多建钴60装置推进辐照加工业的快速发展显然是与现实有差距的。</P>
                         ...
                         <P style="color:#bbb">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;但是，电子加速器的普及应用却同样缓慢。究其原因却并不复杂，根本是就是设备技术原因。</p>
                         <P style="color:#bbb">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在现代科技水平背景下，直线加速器真算不上一套很复杂的系统，国内好几家科研单位、高校、企业都有能力建造起一套辐照加速器，但本质上却都是实验室产品装置。往往是依靠技术专家化好几年时间搭建起一套加速器辐照装置，要作为一项重大技术成果，说不定还要请上个把院士专家开个评审会。即使是进口的加速器设备，也同样是来几个专家和技术人员在现场一件件装配调试几个月再测量验收，出了故障得以上万元1小时的代价请国外专家过来维修。现在的问题是，从事辐照加工服务的是企业而不是科研或事业单位，如何掌握侍候好加速器这种复杂设备，如何承受故障和事故的风险，技术上是否受制于人，对于企业来说是首要考虑的问题。 </p>
                      ...
                      <figure style="text-align:center;">
                        ...
                        <figcaption>图1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;设备生产装配车间</figcaption>
                                                             ...
                                                             <figure>
                                                              ...
                                                              <P style="color:#bbb">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 一般的加速器装置的控制还停留在基于PLC的开关机逻辑控制和简单的故障控保。由于PLC的响应速度为ms量级，而加速器的脉冲精度在us量级，所以我们在控制系统中采用了响应速度在百纳秒量级的先进的现场可编程门阵列FPGA作为控制硬件的核心单元，采用Verilog编写芯片控制逻辑，实现对各种可能出现的复杂状况做出现场实时反应，同时对所有的底层逻辑采用多倍冗余设计，并增加信号级别的逻辑投票功能，以保证底层控制逻辑的高度可靠性。</p>
                                                            ...
                                                            <div>
                                                              ...
                                                              <figure style="text-align:center; padding:0;" class="col-md-6">
                                                             ...
                                                             <div>
                                                              ...
                                                              <P style="color:#bbb">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新研发了扫描窗束流校直装置，使扇状扫描输出的束流成为垂直平行向下的均匀束流。此举有效提升束流利用率20%以上。 </p>
