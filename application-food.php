		...
		<div id="wrapper">
            ...
            <div class="col-md-10" style="padding:20px">
                ...
                <ul>
                    ...
                    <li><P style="color:#bbb">放射性污染: 由电离辐射使食品中某些元素变成放射性元素。允许食品辐射的最大能量水平：电子射线：10 MeV；γ射线：5 MeV；x射线：5 MeV。能量都低于在食品中可能诱导放射性的能量阈值，当然也就不会产生诱导放射性核素及其化合物。</P></li>
                ...
                <ul>
                    <li><P style="color:#bbb">畜禽肉类———畜禽肉类的腐败变质主要是由腐败细菌引起的，一般在辐照前都采用适当的热处理使自溶酶钝化，但过高的温度又会影响肉类的口感和品质，所以采取辐照灭菌完善工艺，同时为了防止辐照过程中的“二次污染”，一般会采用真空包装来隔绝空气、水汽、微生物。低剂量辐射处理方式通常只是为了延长肉类产品的货架期。</P></li>
                    <li><P style="color:#bbb">水产品———水产品捕捞后容易死亡，也容易腐烂。世界卫生组织、联合国粮农组织、国际原子能机构共同认定并批准，以10～20万Ｇｙ辐射剂量来处理鱼，可以减少微生物，延长鲜鱼在3℃以下的保鲜期。</P></li>
                    <li><P style="color:#bbb">蛋类——蛋类的应用辐照针对性杀菌，其中沙门氏菌是对象致病菌。蛋白质在受到辐射时会发生降解使蛋液的粘度降低，因此，一般蛋液及冰冻蛋液用电子射线或γ射线辐射，灭菌效果都比较好。而对带壳鲜蛋可用电子射线处理，剂量应控制在10kGy左右，更高的剂量会使蛋带有H2S等异味。</P></li>
                    <li><P style="color:#bbb">水果——导致水果腐败的微生物大多是霉菌，通常辐射处理是为了抑制霉菌的生长。</P></li>
                    <li><P style="color:#bbb">蔬菜——蔬菜类辐射处理的主要是为了抑制发芽和延缓新陈代谢作用。对脱水蔬菜采用6～10kGy剂量范围的γ射线，不仅可以有效杀灭脱水蔬菜中的微生物，还可以使贮藏保鲜效果达1年以上，而且经生物学检验、营养成分分析和吸收剂量测定，各项指标均符合标准。</P></li>
                    <li><P style="color:#bbb">谷物及其制品——谷物及其制品的辐照处理应以控制虫害及霉菌的繁殖为主。针对昆虫处理所需的剂量范围按立即致死、几天内死去和不育要求分别为3～5kGy、1kGy和0.1～0 .2kGy。而控制谷类中霉菌所需的剂量范围约在2～4kGy之间。</P></li>
                </ul> 
